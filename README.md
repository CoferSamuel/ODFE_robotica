...
A robotics project developed at the University, focusing on robotic systems and autonomous navigation.

## Documentation

For complete project documentation, please refer to:
- **[📄 Main Documentation (PDF)](docs/main.pdf)**
...
│   ├── main.tex            # LaTeX source for documentation
│   ├── multimedia/         # Multimedia resources for documentation
