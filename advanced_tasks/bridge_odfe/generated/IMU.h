...
struct Acceleration
{
     ...
     */
    std::tuple<const float&, const float&, const float&, const long long int&> ice_tuple() const
    {
        return std::tie(XAcc, YAcc, ZAcc, timestamp);
    }
};
...
struct Gyroscope
{
    ...
    std::tuple<const float&, const float&, const float&, const long long int&> ice_tuple() const
    {
        return std::tie(XGyr, YGyr, ZGyr, timestamp);
    }
};
...
struct Magnetic
{
    ...
    std::tuple<const float&, const float&, const float&, const long long int&> ice_tuple() const
    {
        return std::tie(XMag, YMag, ZMag, timestamp);
    }
};
...
struct Orientation
{
    ...
    std::tuple<const float&, const float&, const float&, const long long int&> ice_tuple() const
    {
        return std::tie(Roll, Pitch, Yaw, timestamp);
    }
};
...
struct StreamReader<::RoboCompIMU::Acceleration, S>
{
    ...
    {
        istr->readAll(v.XAcc, v.YAcc, v.ZAcc, v.timestamp);
    }
};
...
struct StreamReader<::RoboCompIMU::Gyroscope, S>
{
    ...
    {
        istr->readAll(v.XGyr, v.YGyr, v.ZGyr, v.timestamp);
    }
};
...
struct StreamReader<::RoboCompIMU::Magnetic, S>
{
    ...
    {
        istr->readAll(v.XMag, v.YMag, v.ZMag, v.timestamp);
    }
};
...
struct StreamReader<::RoboCompIMU::Orientation, S>
{
    ...
    {
        istr->readAll(v.Roll, v.Pitch, v.Yaw, v.timestamp);
    }
};
