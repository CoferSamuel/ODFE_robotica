...
public:
    ...
    void setupUi(QWidget *guiDlg)
    {
        ...
        frame_room->setFrameShape(QFrame::Shape::StyledPanel);
        frame_room->setFrameShadow(QFrame::Shadow::Raised);
        ...
        horizontalLayout_graph = new QHBoxLayout();
        horizontalLayout_graph->setObjectName("horizontalLayout_graph");
        localizationPlot = new QCustomPlot(guiDlg);
        localizationPlot->setObjectName("localizationPlot");
        QSizePolicy sizePolicy1(QSizePolicy::Expanding, QSizePolicy::Expanding);
        sizePolicy1.setHorizontalStretch(0);
        sizePolicy1.setVerticalStretch(0);
        sizePolicy1.setHeightForWidth(localizationPlot->sizePolicy().hasHeightForWidth());
        localizationPlot->setSizePolicy(sizePolicy1);
        localizationPlot->setMinimumSize(QSize(400, 50));

        horizontalLayout_graph->addWidget(localizationPlot);


        horizontalLayout_9->addLayout(horizontalLayout_graph);
        ...
        sizePolicy1.setHeightForWidth(label_img->sizePolicy().hasHeightForWidth());
        label_img->setSizePolicy(sizePolicy1);
    ...
    {
        guiDlg->setWindowTitle(QCoreApplication::translate("guiDlg", "FullApartment", nullptr));
