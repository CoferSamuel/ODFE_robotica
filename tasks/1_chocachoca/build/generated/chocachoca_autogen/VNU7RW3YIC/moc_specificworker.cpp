...
Q_CONSTINIT static const qt_meta_stringdata_SpecificWorker_t qt_meta_stringdata_SpecificWorker = {
    {
        ...
        QT_MOC_LITERAL(46, 4),  // "auto"
        QT_MOC_LITERAL(51, 6),  // "points"
        QT_MOC_LITERAL(58, 15),  // "QGraphicsScene*"
        QT_MOC_LITERAL(74, 5),  // "scene"
        QT_MOC_LITERAL(80, 32),  // "filter_min_distance_cppitertools"
        QT_MOC_LITERAL(113, 39),  // "std::optional<RoboCompLidar3D..."
        QT_MOC_LITERAL(153, 24),  // "RoboCompLidar3D::TPoints"
        QT_MOC_LITERAL(178, 15),  // "new_target_slot"
        QT_MOC_LITERAL(194, 21),  // "update_robot_position"
        QT_MOC_LITERAL(216, 9),  // "emergency"
        QT_MOC_LITERAL(226, 7),  // "restore"
        QT_MOC_LITERAL(234, 13)   // "startup_check"
    },
    "SpecificWorker",
    "initialize",
    "",
...
void SpecificWorker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->draw_lidar((*reinterpret_cast< std::add_pointer_t<auto>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QGraphicsScene*>>(_a[2]))); break;
        case 3: { std::optional<RoboCompLidar3D::TPoints> _r = _t->filter_min_distance_cppitertools((*reinterpret_cast< std::add_pointer_t<RoboCompLidar3D::TPoints>>(_a[1])));
            if (_a[0]) *reinterpret_cast< std::optional<RoboCompLidar3D::TPoints>*>(_a[0]) = std::move(_r); }  break;
        case 4: _t->new_target_slot((*reinterpret_cast< std::add_pointer_t<QPointF>>(_a[1]))); break;
        case 5: _t->update_robot_position(); break;
